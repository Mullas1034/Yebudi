...
// Inline SVGs ported from the mockup so the app needs no icon dependency for chrome.
...
export function ForgeIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M6.5 6.5h11M6.5 17.5h11M9 6.5v11M15 6.5v11M3 9h3M3 15h3M18 9h3M18 15h3" />
    </svg>
  );
}
...
export function PitchIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M12 8.5 14.6 10.4 13.6 13.5h-3.2L9.4 10.4 12 8.5Z" />
    </svg>
  );
}
